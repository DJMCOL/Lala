<?php namespace App\Http\Controllers;
	...
	class AdminInfoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Telefono','name'=>'tel','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Tel","name"=>"tel","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
