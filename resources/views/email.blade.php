            ...
            <table cellpadding="0" cellspacing="0" border="0" width="600" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif">
                <tr>
                    <td width="100%" style="width:100%; text-align: center; border:0; padding: 0; background-color: #fff">
                        <a target="_blank" href="{{$http}}"><img src="{{$http}}/img/logo.png" style="width:30%; display: block; margin: 10px auto" ></a>
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="middle" bgcolor="#F2F2F2" width="100%" style="width:100%; text-align: center; border:0; padding: 0; background-color: #F2F2F2;">
                        <table cellpadding="0" align="center" cellspacing="0" border="0" width="400">
                            <tr>
                                ...
                                <p style="color: #808080; font-size: 12pt">Se ha realizado un contacto desde el formulario de <a target="_blank" href='{{$http}}/' style='text-decoration: none'><span style='font-weight:700;font-size: 16px;color: #70B125;'>{{$http}}</span></a>.<br>
                                ...
                                <div style='padding-left: 10px'>
                                    <p style="color: #808080; font-size: 12pt">Nombre: {{$name}}</p>
                                    <p style="color: #808080; font-size: 12pt">Correo Electronico: {{$email}}</p>
                                    <p style="color: #808080; font-size: 12pt">Mensaje: </p>
                                    <p style="color: #808080; font-size: 12pt">{{$messague}}</p>
                                    <br>
                                </div>
